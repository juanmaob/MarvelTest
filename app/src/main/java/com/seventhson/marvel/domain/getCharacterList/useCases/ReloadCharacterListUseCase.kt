...
class ReloadCharacterListUseCase @Inject constructor(
    private val repository: CharacterListRepository
) {

    fun executeCall(params: CharacterListParams): Flow<List<CharacterDetail>> = repository.reloadCharacterList(params)
